...
import com.spring.reactive.service.CityService;
...
public class CityController{
    ...
    public Flux<CityReadDto> listCities(Pageable page) {
        return cityService.listCities(page);
    }
    ...
    public Mono<CityReadDto> createCity(@Valid @RequestBody CityWriteDto cityWriteDto) {
        return cityService.createCity(cityWriteDto);
    }
    ...
    public Mono<CityReadDto> updateCity(@PathVariable String cityId, @Valid @RequestBody CityWriteDto cityWriteDto) {
        return cityService.updateCity(cityId,cityWriteDto);
    }
